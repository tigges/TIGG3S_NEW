...
export function renderHome() {
  ...
  <section class="hero">
    <div class="hero-video">
      <img class="hero-poster" src="${escapeHtml(hero.poster)}" alt="" width="1920" height="1080" fetchpriority="high" decoding="async" />
      <video autoplay muted loop playsinline webkit-playsinline preload="metadata" poster="${escapeHtml(hero.poster)}">
        <source src="${escapeHtml(hero.video)}" type="video/mp4" />
      </video>
    </div>
    <p class="hero-title">${escapeHtml(hero.prefix)}<b>${escapeHtml(hero.title)}</b></p>
